...
// in multer we using diskstorage to store files in disk there are other options available such as - memory storage etc , but storing files in memiry is not right 
